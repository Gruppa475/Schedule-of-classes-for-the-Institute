...
// Set default panel
if ($panel == '' && in_array($widget->position, array('top-a', 'top-b', 'top-c', 'top-d', 'bottom-a', 'bottom-b', 'bottom-c', 'bottom-d', 'bottom-e', 'bottom-f', 'bottom-g', 'main-top', 'main-bottom', 'sidebar-a', 'sidebar-b'))) {
...
// Set title
if (in_array($widget->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'footer', 'offcanvas'))) {
    $title = '';
...
if ($widget->menu) {
    ...
    } else if (in_array($widget->position, array('toolbar-r' ,'toolbar-l', 'footer'))) {
        $renderer = 'subnav';
